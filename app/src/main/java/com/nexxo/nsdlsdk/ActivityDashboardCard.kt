...
class ActivityDashboardCard : AppCompatActivity() {
   ...
   /* var d:iTokenData = object : iTokenData {
        override fun getTokenData(pwdKey: String, tokenKey: String) {
            Utility.logData("PWD key "+pwdKey)
        }
    }*/
